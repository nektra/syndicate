...
// Construct interface of the lottery contract instance
const li_abi = require("../deployment/LotteryInvestment.abi.js");
const li_interface = web3.eth.contract(li_abi);
const li_instance = li_interface.at(li_address);

// Gas amount to be set
const gas = 3500;

li_instance.set_transfer_gas(gas, {from: sender_accounts[1], gasPrice: 5000000000, gas: 300000});